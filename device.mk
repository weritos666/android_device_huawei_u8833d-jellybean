...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/u8833d/prebuilt/system/etc/camera-permission.sh:system/etc/camera-permission.sh \
    device/huawei/u8833d/prebuilt/system/lib/libcameraservice.so:system/lib/libcameraservice.so \
    device/huawei/u8833d/prebuilt/system/lib/libcamera_client.so:system/lib/libcamera_client.so

PRODUCT_COPY_FILES += \
    device/huawei/u8833d/prebuilt/system/etc/dhcpcd/dhcpcd.conf:system/etc/dhcpcd/dhcpcd.conf \
    device/huawei/u8833d/prebuilt/system/etc/AudioFilter_MSM8X25_U8825D.csv:system/etc/AudioFilter.csv \
    ...
    device/huawei/u8833d/prebuilt/system/etc/init.qcom.wifi.sh:system/etc/init.qcom.wifi.sh \
...
PRODUCT_COPY_FILES += \
    device/huawei/u8833d/prebuilt/system/etc/firmware/yamato_pfp.fw:system/etc/firmware/yamato_pfp.fw \
    device/huawei/u8833d/prebuilt/system/etc/firmware/yamato_pm4.fw:system/etc/firmware/yamato_pm4.fw
...
PRODUCT_COPY_FILES += \
    device/huawei/u8833d/prebuilt/system/lib/egl/libq3dtools_adreno200.so:system/lib/egl/libq3dtools_adreno200.so \
    device/huawei/u8833d/prebuilt/system/lib/egl/libGLESv2_adreno200.so:system/lib/egl/libGLESv2_adreno200.so \
    device/huawei/u8833d/prebuilt/system/lib/egl/libGLESv1_CM_adreno200.so:system/lib/egl/libGLESv1_CM_adreno200.so \
    device/huawei/u8833d/prebuilt/system/lib/egl/libEGL_adreno200.so:system/lib/egl/libEGL_adreno200.so \
    device/huawei/u8833d/prebuilt/system/lib/egl/eglsubAndroid.so:system/lib/egl/eglsubAndroid.so \
    device/huawei/u8833d/prebuilt/system/lib/libC2D2.so:system/lib/libC2D2.so \
    device/huawei/u8833d/prebuilt/system/lib/libOpenVG.so:system/lib/libOpenVG.so \
    device/huawei/u8833d/prebuilt/system/lib/libsc-a2xx.so:system/lib/libsc-a2xx.so \
    device/huawei/u8833d/prebuilt/system/lib/libgsl.so:system/lib/libgsl.so \
    device/huawei/u8833d/prebuilt/system/lib/egl/libGLESv2S3D_adreno200.so:system/lib/egl/libGLESv2S3D_adreno200.so \
    device/huawei/u8833d/prebuilt/system/lib/libc2d2_z180.so:system/lib/libc2d2_z180.so
